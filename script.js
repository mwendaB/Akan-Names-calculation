function submition(){
  ...
  {
    document.getElementById("display").innerHTML =  ("you were born on Friday,your akan name is "+ femaleName[3]);
  }
  else if (Math.round(result)==4 && gender==='female')
  {
    document.getElementById("display").innerHTML = ("you were born on Saturday,your akan name is "+ femaleName[4]);
  }
  else if (Math.round(result)==5 && gender==='female')
  {
    document.getElementById("display").innerHTML =  ("you were born on Sunday,your akan name is "+ femaleName[5]);
  }
  else if (Math.round(result)==6 && gender==='female')
  {
    document.getElementById("display").innerHTML =  ("you were born on Sunday,your akan name is "+ femaleName[6]);
  }
